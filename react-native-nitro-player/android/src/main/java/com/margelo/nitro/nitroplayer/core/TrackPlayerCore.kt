...
class TrackPlayerCore private constructor(
    ...
    internal val handler = android.os.Handler(android.os.Looper.getMainLooper())
    ...
    internal var currentTrackIndex: Int = -1 // Index in the original playlist (currentTracks)

    // Lazy URL loading listeners (see TrackPlayerCoreLazyURLLoading.kt)
    internal val onTracksNeedUpdateListeners = mutableListOf<WeakReference<OnTracksNeedUpdateListener>>()
     ...
     */
    internal fun rebuildQueueFromCurrentPosition() {
    ...
    internal fun getActualQueueInternal(): List<TrackItem> {
