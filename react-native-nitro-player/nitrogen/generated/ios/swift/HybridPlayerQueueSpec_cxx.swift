...
open class HybridPlayerQueueSpec_cxx {
  ...
  @inline(__always)
  public final func shufflePlaylist(playlistId: std.string, options: bridge.std__optional_ShufflePlaylistOptions_) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.shufflePlaylist(playlistId: String(playlistId), options: options.value)
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
